...
export class RAGServer {
  ...
  async handleQueryDocuments(
    ...
    try {
      ...
      if (validatedType) filters.type = validatedType
      if (validatedTags.length > 0) filters.tags = validatedTags
      if (args.project) filters.project = args.project
      if (validatedMinScore !== undefined) filters.minScore = validatedMinScore
